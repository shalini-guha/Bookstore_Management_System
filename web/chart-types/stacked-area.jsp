       ...
       var chart = new CanvasJS.Chart("chartContainer", {
           ...
           toolTip: {
               content: function (e) {
                   ...
                   var str1 = weekday[new Date(e.entries[0].dataPoint.x).getDay()] + "<br/>  <span style =' color:" + e.entries[0].dataSeries.color + "';>" + e.entries[0].dataSeries.name + "</span>: <strong>" + e.entries[0].dataPoint.y + " hrs</strong> <br/>";
                   return str1
               }
           },
