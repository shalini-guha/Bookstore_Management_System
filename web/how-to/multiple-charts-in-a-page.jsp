...
<jsp:include page="../WEB-INF/pages/template.jsp">
	<jsp:param value="Multiple Charts in a Page" name="pageTitle"/>
	<jsp:param value="<div id='chartContainer1' style='width: 49%; height: 300px;display: inline-block;'></div>
		...
		<div id='chartContainer4' style='width: 49%; height: 300px;display: inline-block;'></div>" name="content"/> 	
</jsp:include>
